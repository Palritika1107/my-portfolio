...
const Contact = () => {
    return (
        <div name="contact" className="w-full h-full contact-page pt-10 flex flex-col justify-center items-center  bg-teal-500">
            
            
            {/* Content */}
            <div className="text-center">
                <h2 className="text-3xl lg:text-5xl font-bold text-yellow-300 mb-2 text-with-shadow">Contact Me</h2>
            ...
            <div className="max-w-5xl h-[90vh] flex flex-col justify-center items-center px-4">
                <div className="max-w-lg mx-auto lg:w-[2000px]">
                    <form className="bg-[#F2EDE4] p-8 rounded-lg shadow-2xl"
                        ...
                        <p className="text-gray-700 pt-2 pb-4">Submit the form below or shoot me an email at: <span className="font-bold"></span></p>
                        <input
                            type="text"
                            name="name"
